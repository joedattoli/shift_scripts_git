...
batter_means = pd.read_excel(r"C:\Users\joedattoli\Desktop\ShiftScripts\batter_means_lamore10.xlsx")
...
with pd.ExcelWriter(r"C:\Users\joedattoli\Desktop\ShiftScripts\difference_woba_lamore10.xlsx") as writer:
    dif_frame.to_excel(writer)
with pd.ExcelWriter(r"C:\Users\joedattoli\Desktop\ShiftScripts\mean_data_plus_lamore10.xlsx") as writer:
