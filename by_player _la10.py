...
with pd.ExcelWriter(r"C:\Users\joedattoli\Desktop\ShiftScripts\batter_means_la10.xlsx") as writer:
    avgs_df_10.to_excel(writer)
    
#auto_run next script so I can leave for the day and not be behind
runpy.run_path(r'C:\Users\joedattoli\Desktop\ShiftScripts\together_splits.py')